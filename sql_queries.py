...
songplay_table_insert = ("INSERT INTO songplays (songplay_id, user_id, song_id, artist_id, start_time, level, session_id, location, user_agent) VALUES (DEFAULT, %s, %s, %s, %s, %s, %s, %s, %s);")
